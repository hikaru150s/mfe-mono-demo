...
// node_modules/lodash-v4/lodash.js
var require_lodash = __commonJS({
  "node_modules/lodash-v4/lodash.js"(exports2, module2) {
    "use strict";
    (function() {
      var undefined;
      var VERSION = "4.17.21";
      ...
      var runInContext = function runInContext2(context) {
        ...
        LodashWrapper2.prototype = baseCreate(baseLodash.prototype);
        ...
        var wrapperAt = flatRest(function(paths) {
          ...
          return new LodashWrapper2(value, this.__chain__).thru(function(array) {
...
// libs/lodash-wrapper/src/index.ts
var src_exports = {};
...
// libs/lodash-wrapper/src/lib/lodash-wrapper.ts
var LodashVersion = /* @__PURE__ */ ((LodashVersion2) => {
  LodashVersion2["V3"] = "lodash-v3";
  LodashVersion2["V4"] = "lodash-v4";
  return LodashVersion2;
})(LodashVersion || {});
var LodashWrapper = class _LodashWrapper {
  constructor(version, lodash) {
    this.version = version;
    if ("default" in lodash) {
      this.lodash = lodash.default;
    } else {
      this.lodash = lodash;
    }
  }
  static async initializeAsync(version) {
    switch (version) {
      case "lodash-v3" /* V3 */:
        return new _LodashWrapper(version, await import("lodash-v3"));
      case "lodash-v4" /* V4 */:
        return new _LodashWrapper(version, await Promise.resolve().then(() => __toESM(require_lodash())));
      default:
        throw new Error(`Unsupported lodash version: ${version}`);
    }
  }
  isV3() {
    return this.version === "lodash-v3" /* V3 */;
  }
  isV4() {
    return this.version === "lodash-v4" /* V4 */;
  }
  get v3() {
    return this.lodash;
  }
  ...
  get engineVersion() {
    return this.lodash.VERSION;
  }
  map(array, key) {
    if (this.isV3()) {
      return this.v3.pluck(array, key);
    } else if (this.isV4()) {
      return this.v4.map(array, key);
    } else {
      throw new Error(`Unsupported lodash version: ${this.version}`);
    }
  }
  maxBy(array, key) {
    if (this.isV3()) {
      return this.v3.max(array, key);
    } else if (this.isV4()) {
      return this.v4.maxBy(array, key);
    } else {
      throw new Error(`Unsupported lodash version: ${this.version}`);
    }
  }
  minBy(array, key) {
    if (this.isV3()) {
      return this.v3.min(array, key);
    } else if (this.isV4()) {
      return this.v4.minBy(array, key);
    } else {
      throw new Error(`Unsupported lodash version: ${this.version}`);
    }
  }
  support() {
    if (this.isV3()) {
      return this.v3.support;
    } else if (this.isV4()) {
      throw new Error("Removed support for lodash-v4");
    } else {
      throw new Error(`Unsupported lodash version: ${this.version}`);
    }
  }
